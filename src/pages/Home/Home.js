        ...
        <div className="hero__left">
          <div className="hero__card">
            <h1 className="hero__text">
              Earn up to $350 <span className="hero__text--highlighted">*</span> when you open a
              chequing account online!
            </h1>
            <div className="hero__underline"></div>
            <p className="hero__description">
              Plus, get access to <span className="hero__description--bold">personalized BMO insights</span> in the BMO app. Real
          ...
          <div className="hero__cta">
            ...
            <Link className="hero__button" to="/">
